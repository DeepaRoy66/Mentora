            ...
            <div className="flex items-center gap-3 md:gap-4 flex-1 justify-end">
              ...
              <div className="hidden md:flex items-center gap-2">
                <Button
                  variant="ghost"
                  asChild
                  className="text-base font-semibold text-gray-700 hover:text-black hover:bg-gray-100/80 h-10 px-4"
                >
                  <Link href="/">
              ...
              <div className="hidden md:flex items-center">
                {loading ? (
                  ...
                  <Button
                    variant="ghost"
                    asChild
                    className="rounded-full pl-2 pr-5 h-11 hover:bg-gray-100"
                  >
        ...
        <div className="md:hidden absolute top-[calc(72px+48px)] left-0 right-0 border-b border-gray-200 bg-white/95 backdrop-blur-2xl shadow-xl animate-in slide-in-from-top-2">
          <div className="p-5 space-y-5">
            ...
            <div className="space-y-2">
              <Link
                href="/"
                className="flex items-center gap-4 p-3 rounded-xl hover:bg-gray-100 text-base font-semibold text-gray-800 transition-colors"
              >
            ...
            <div className="pt-5 border-t border-gray-200">
              {user ? (
                ...
                <Button
                  className="w-full bg-black text-white hover:bg-black/80 font-bold h-11 text-base"
                  onClick={() => signIn("google")}
                >
                  <LogIn className="h-5 w-5 mr-2" />
                  Login with Google
