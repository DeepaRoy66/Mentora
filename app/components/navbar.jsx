              ...
              <div className="hidden md:flex items-center">
                {loading ? (
                  ...
                  <Button 
                    ...
                    className="rounded-full bg-black text-white hover:bg-black/80 font-semibold px-6 text-base"
                  >
          ...
          <div className="p-5 space-y-5">
            ...
            <div className="space-y-2">
              ...
              <Link href="/generatesummary" className="flex items-center gap-4 p-3 rounded-xl hover:bg-gray-100 text-base font-semibold text-gray-800 transition-colors">
                <FileText className="h-6 w-6" /> Generate Summary
              </Link>
              <Link href="/questions" className="flex items-center gap-4 p-3 rounded-xl hover:bg-gray-100 text-base font-semibold text-gray-800 transition-colors">
                <MessageSquare className="h-6 w-6" /> Q&A
              </Link>
              <Link href="/mcq-contest" className="flex items-center gap-4 p-3 rounded-xl hover:bg-gray-100 text-base font-semibold text-gray-800 transition-colors">
                <Swords className="h-6 w-6" /> MCQ-War
              </Link>
              <Link href="/eco-editor" className="flex items-center gap-4 p-3 rounded-xl hover:bg-gray-100 text-base font-semibold text-gray-800 transition-colors">
                <Leaf className="h-6 w-6" /> Ecoeditor
              </Link>
              {user && (
                <Link href="/badges" className="flex items-center gap-4 p-3 rounded-xl hover:bg-gray-100 text-base font-semibold text-gray-800 transition-colors">
                  <Trophy className="h-6 w-6" /> Badges
                </Link>
              )}
