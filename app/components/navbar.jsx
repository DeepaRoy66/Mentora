...
export function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 flex flex-col font-sans tracking-tight shadow-sm">
          ...
          <div className="flex h-[72px] items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-3 md:gap-4 flex-1 justify-end">
                ...
                {isSearchOpen ? (
                  <div className="relative w-full animate-in fade-in zoom-in-95 duration-200">
                    ...
                    {showSuggestions && (
                      <div 
                        ref={suggestionsRef}
                        className="absolute top-full left-0 right-0 mt-2 bg-white rounded-xl shadow-xl border border-gray-100 overflow-hidden animate-in slide-in-from-top-2 duration-200 z-50"
                      >
                        {searchLoading ? (
                          ...
                          <ul className="max-h-60 overflow-y-auto py-1">
                            {suggestions.map((s, idx) => (
                              <li 
                                ...
                                className="px-4 py-3 hover:bg-gray-50 cursor-pointer text-sm text-gray-700 flex items-center gap-2"
                              >
              ...
              <div className="hidden md:flex items-center gap-1">
                ...
                <Button variant="ghost" asChild className="text-base font-semibold text-gray-700 hover:text-black hover:bg-gray-100/80 h-10 px-4">
                  <Link href="/upload"><Upload className="h-5 w-5 mr-2" />Upload</Link>
                </Button>
                <Button variant="ghost" asChild className="text-base font-semibold text-gray-700 hover:text-black hover:bg-gray-100/80 h-10 px-4">
                  <Link href="/generatesummary"><FileText className="h-5 w-5 mr-2" />Pdf-Summary</Link>
                </Button>
                <Button variant="ghost" asChild className="text-base font-semibold text-gray-700 hover:text-black hover:bg-gray-100/80 h-10 px-4">
                  <Link href="/questions"><MessageSquare className="h-5 w-5 mr-2" />Q&A</Link>
                </Button>
                <Button variant="ghost" asChild className="text-base font-semibold text-gray-700 hover:text-black hover:bg-gray-100/80 h-10 px-4">
                  <Link href="/mcq-contest"><Swords className="h-5 w-5 mr-2" />MCQ-War</Link>
                </Button>
                <Button variant="ghost" asChild className="text-base font-semibold text-gray-700 hover:text-black hover:bg-gray-100/80 h-10 px-4">
                  <Link href="/eco-editor"><Leaf className="h-5 w-5 mr-2" />Ecoeditor</Link>
                </Button>
                {user && (
                  <Button variant="ghost" asChild className="text-base font-semibold text-gray-700 hover:text-black hover:bg-gray-100/80 h-10 px-4">
                    <Link href="/badges"><Trophy className="h-5 w-5 mr-2" />Badges</Link>
                  </Button>
                )}
              </div>
      ...
      {/* MOBILE DROPDOWN... (Keep existing code) */}
      {mobileMenuOpen && (
        <div className="md:hidden absolute top-[calc(72px+48px)] left-0 right-0 border-b border-gray-200 bg-white/95 backdrop-blur-2xl shadow-xl animate-in slide-in-from-top-2">
          <div className="p-5 space-y-5">
            ...
            <div className="space-y-2">
              <Link href="/" className="flex items-center gap-4 p-3 rounded-xl hover:bg-gray-100 text-base font-semibold text-gray-800 transition-colors"><Home className="h-6 w-6" /> Home</Link>
              <Link href="/upload" className="flex items-center gap-4 p-3 rounded-xl hover:bg-gray-100 text-base font-semibold text-gray-800 transition-colors"><Upload className="h-6 w-6" /> Upload PDF</Link>
              <Link href="/generatesummary" className="flex items-center gap-4 p-3 rounded-xl hover:bg-gray-100 text-base font-semibold text-gray-800 transition-colors"><FileText className="h-6 w-6" /> Generate Summary</Link>
              <Link href="/questions" className="flex items-center gap-4 p-3 rounded-xl hover:bg-gray-100 text-base font-semibold text-gray-800 transition-colors"><MessageSquare className="h-6 w-6" /> Q&A</Link>
              <Link href="/mcq-contest" className="flex items-center gap-4 p-3 rounded-xl hover:bg-gray-100 text-base font-semibold text-gray-800 transition-colors"><Swords className="h-6 w-6" /> MCQ-War</Link>
              <Link href="/eco-editor" className="flex items-center gap-4 p-3 rounded-xl hover:bg-gray-100 text-base font-semibold text-gray-800 transition-colors"><Leaf className="h-6 w-6" /> Ecoeditor</Link>
              {user && (<Link href="/badges" className="flex items-center gap-4 p-3 rounded-xl hover:bg-gray-100 text-base font-semibold text-gray-800 transition-colors"><Trophy className="h-6 w-6" /> Badges</Link>)}
              <Link href="/profile" className="flex items-center gap-4 p-3 rounded-xl hover:bg-gray-100 text-base font-semibold text-gray-800 transition-colors"><User className="h-6 w-6" /> Profile</Link>
            </div>
              ...
              {user ? (
                <div className="flex items-center justify-between px-2">
                   <div className="flex items-center gap-3">
                      ...
                      <div className="text-sm"><div className="font-bold text-gray-900 text-base">{user.name}</div><div className="text-xs text-gray-500">{user.email}</div></div>
                   </div>
                   <Button variant="ghost" size="icon" onClick={() => signOut()}><LogOut className="h-6 w-6 text-red-500" /></Button>
                </div>
              ) : (
                <Button className="w-full bg-black text-white hover:bg-black/80 font-bold h-11 text-base" onClick={() => signIn("google")}><LogIn className="h-5 w-5 mr-2" />Login with Google</Button>
              )}
            </div>
          </div>
        </div>
