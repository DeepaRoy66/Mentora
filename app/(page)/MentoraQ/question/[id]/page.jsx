...
export default function QuestionDetail() {
  ...
  const fetchData = async (signal) => {
    try {
      ...
      if (!qRes.ok || !aRes.ok) throw new Error("Failed to load data")
      ...
      <main className="max-w-4xl mx-auto p-6">
        ...
        <div className="ml-12 mt-6">
          ...
          {(question.comments || []).map((c) => (
            <div key={c._id} className="bg-gray-50 p-3 rounded mt-2">
              <p>{c.text}</p>
        ...
        {/* Answers */}
        <h2 className="text-2xl font-bold mt-10">{answers.length} Answers</h2>
